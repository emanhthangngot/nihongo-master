...
const WORDS: Word[] = [
  { id:'1', word:'食べる', reading:'たべる', romaji:'taberu', partOfSpeech:'verb (godan)', jlptLevel:'N5',
  ...
  { id:'2', word:'勉強', reading:'べんきょう', romaji:'benkyō', partOfSpeech:'noun / suru-verb', jlptLevel:'N5',
  ...
  { id:'3', word:'難しい', reading:'むずかしい', romaji:'muzukashii', partOfSpeech:'i-adjective', jlptLevel:'N5',
      ...
      <div className="liquid-glass rounded-2xl p-8 border border-white/8">
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="mono text-sm text-muted-foreground mt-1">{entry.romaji} · {entry.partOfSpeech}</p>
                ...
                <div key={f.word} className="liquid-glass rounded-2xl p-4 cursor-pointer border border-white/6 hover:border-accent-ember/30 hover:scale-[1.02] transition-all"
                  onClick={() => {
                    ...
                    setSelected(found ?? {
                      ...
                      partOfSpeech: 'noun', jlptLevel: f.jlpt as Word['jlptLevel'], patternName: 'Heiban',
